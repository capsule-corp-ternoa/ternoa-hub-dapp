...
const NftDetailTemplate: React.FC<INftDetailTemplate> = ({
  ...
  return (
    <div className="flex flex-col md:flex-row justify-center h-[max-content]">
      <div className="md:ml-s24 md:mb-[0px] flex flex-col justify-start mr-s20">
